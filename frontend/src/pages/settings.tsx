...
export default function Settings() {
  ...
  const [category, setCategory] = useState<AllowedCategory>(() => {
    const saved = (localStorage.getItem('settings_category') as AllowedCategory | null) || 'branches';
    return (ALLOWED as readonly string[]).includes(saved) ? (saved as AllowedCategory) : 'branches';
  });
