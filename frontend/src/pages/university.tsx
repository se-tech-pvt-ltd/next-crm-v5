    ...
    <Card className="overflow-hidden rounded-xl border-gray-200 shadow-sm">
      <div className="relative">
        <img
          ...
          loading="lazy"
        />
        <img src={item.avatarUrl} alt={`${item.name} logo`} className="absolute -bottom-3 left-4 w-14 h-14 rounded-full object-cover ring-2 ring-white shadow-md" loading="lazy" />
      </div>
