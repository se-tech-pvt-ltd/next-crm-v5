        ...
        leftContent={(
          <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="flex items-center space-x-2">
                      {!isEditing && String(isEditing ? (editData.phone || '') : (student?.phone || '')).trim() !== '' ? (
                        <a
                          href={(() => {
                            try {
                              const raw = String(isEditing ? (editData.phone || '') : (student?.phone || ''));
            ...
            <CollapsibleCard
              ...
              header={<CardTitle className="flex items-center space-x-2"><GraduationCap className="w-4 h-4 text-primary" /><span>Academic Information</span></CardTitle>}>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                <div className="space-y-2">
