            ...
            {!isEditing ? (
              <>
                <Button
                  ...
                  onClick={() => { try { setLocation(`/students/${student?.id}/admission`); } catch {} onOpenChange(false); if (typeof onOpenAddApplication === 'function') { setTimeout(() => onOpenAddApplication(student?.id), 160); } }}
